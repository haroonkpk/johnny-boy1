            ...
            >
              <div className="max-w-[1600px] mx-auto px-4 py-2 flex items-center justify-center gap-2 text-center">
                ...
                <p className="text-[10px] sm:text-xs font-bold uppercase tracking-wider">
                  Your account is pending approval. Please wait for admin to
              ...
              <div className="flex-shrink-0">
                <Link href="/" className="flex items-center">
                  <img
                    ...
                    alt="Logo"
                    className="h-[clamp(7rem,7vw,7.5rem)] w-auto max-w-[70vw] rounded-full object-contain transition-all duration-300"
                  />
                </Link>
              </div>
